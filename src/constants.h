...
#define NEXT_LEVEL_BACKGROUND_COLOR 0
...
#define PROVISIONAL_FLOOR_TILE_ID current_map[0]
#define PROVISIONAL_OBSTACLE_TILE_ID current_map[1]
#define PROVISIONAL_ENEMY_OCUPIED_TILE_ID current_map[2]
